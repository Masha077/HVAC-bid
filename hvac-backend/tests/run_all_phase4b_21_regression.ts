...
console.log('==================================================');
console.log('   HVAC BIS BACKEND PHASE 4B - 21 REGRESSION RUNNER');
console.log('==================================================\n');
...
const testFiles = [
  ...
  'tests/test_phase19_frontend_integration.ts',
  'tests/test_phase20_full_system.ts',
  'tests/test_phase21_production_hardening.ts'
];
...
if (failedCount > 0) {
  ...
  console.log(`\n>>> ALL ${testFiles.length}/${testFiles.length} PHASE 4B-21 REGRESSION SUITES PASSED CLEANLY! <<<`);
}
